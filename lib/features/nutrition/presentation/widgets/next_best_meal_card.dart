              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Phase 25.2 "why" line — reads the reason
                      // generated by the service (which matches the
                      // priority tier that fired) so the user
                      // understands the pick before they act on it.
                      _ReasonPill(reason: recommendation.reason),
                      ...
                      _ImpactLine(impact: recommendation.impactString),
...
/// Phase 25.2 "why" pill explaining which priority tier produced the
/// suggestion. Short copy (<~40 chars) comes from [NextMealRecommendation.reason].
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.lightbulb_outline, color: _neon, size: 14),
...
/// Phase 25.2 impact line preview — tells the user what adding this
/// meal will do to their numbers *before* they commit. Deliberately
/// rendered just above the primary CTA so it's the last thing the
/// eye lands on before the tap.
class _ImpactLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        const Icon(Icons.trending_up, color: _neonGreen, size: 16),
        const SizedBox(width: 6),
        Expanded(
          child: Text(
            impact,
